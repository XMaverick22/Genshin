...
async function createWidget() {
  ...
  if(args.widgetParameter == null) {
    bg_gradient(widget)
  } else {widget.backgroundImage = await shadowImage(bg_img())
  } 
  // 布局
  //第一栏
  ...
  bottomHorizon.addSpacer(isLarge ? 20 : 10)
...
// 树脂
  ...
  ResinElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.7))
  ResinElement.textOpacity = 1
ResinElement.font = Font.boldSystemFont(ThemeConfig.textSize)
  
  let ResinTipElement = resinTipStack.addText(resinTipText)
  ResinTipElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.9))
  ...
  ResinDiscountTipElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.9))
  ...
  TaskElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.7))
  ...
  TaskTipElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.9))
  ...
  CoinElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.7))
  ...
  CoinTipElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.9))
  ...
  if (!isSmall) {
    ...
    transfmText.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.7))
  ...
  if (`${resin.transformer.reached}` == true) {
    ...
    TransfmTextElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.7))
  }
  TransfmTextElement.textOpacity = 1
  TransfmTextElement.font = Font.boldSystemFont(ThemeConfig.textSize)
  ...
  expeditionsTitleElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.7))
  expeditionsTitleElement.textOpacity = 1
  expeditionsTitleElement.font = Font.boldSystemFont(ThemeConfig.textSize)
    ...
    if (isOngoing) {
      ...
      if (+remained_time < minCoverTime) minCoverTime = +remained_time
        ...
        if (expeditions[i].status !== 'Finished') {
          ...
          remainedTimeElemnet.textOpacity = 0.7
          remainedTimeElemnet.font = Font.boldSystemFont(ThemeConfig.tipSize)
        } else {
          isHasFinished = true
          ...
          remainedTimeElemnet.textOpacity = 0.9
          remainedTimeElemnet.font = Font.boldSystemFont(ThemeConfig.tipSize)
        }
        expeditionStack.centerAlignContent()
      }
  }
  expeditionsTitleStack.addSpacer(20)
  if (isHasFinished) {
    ...
    expeditionsRecoverElement.textOpacity = 0.9
    expeditionsRecoverElement.font = Font.boldSystemFont(ThemeConfig.textSize)
  } else {
    let expeditionsRecoverElement = expeditionsTitleStack.addText(isSmall ? "":`最早完成时间：${await getClock(minCoverTime)}`)
    expeditionsRecoverElement.textColor = Color.dynamic(Color.white(), new Color('#FFFFFF',0.9))
